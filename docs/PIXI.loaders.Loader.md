...
The new loader, extends Resource Loader by Chad Engler : https://github.com/englercj/resource-loader ```js let loader = PIXI.loader; // pixi exposes a premade instance for you to use. //or let loader = new PIXI.loaders.Loader(); // you can also create your own if you want loader.add('bunny',"data/bunny.png"); loader.once('complete',onAssetsLoaded); loader.load(); ```
<dl>
                    <dt>Source:</dt>
                    <dd>
                        <ul>
                            <li>
                                <a>libs/pixi.js</a>, <a>line 31546</a>
                            </li>
                        </ul>
                    </dd>
                    <dt>See:</dt>
                    <dd>
                        <ul>
                            <li><a>https://github.com/englercj/resource-loader</a></li>
                        </ul>
                    </dd>
                </dl>
