# Class: HardLightShader

## HardLightShader (gl, tilingMode)

#### new HardLightShader (gl, tilingMode)

##### Parameters:

| Name | Type | Description |
| --- | --- | --- |
| `gl` | [PIXI.Shader](PIXI.Shader.html) | The WebGL shader manager this shader works for. |
| `tilingMode` | number | 0 for default, 1 for simple tiling, 2 for tiling |
...
<dl>
                    ...
                    <dd>
                        <ul>
                            <li>
                                <a>libs/pixi-picture.js</a>, <a>line 19</a>
                            </li>
                        </ul>
                    </dd>
                </dl>
