...
<dl>
                            <hr>
                            <dt>
                                <h4>cacheEntry<span> :<a>CacheEntry</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>Cache entry, for images. In all cases _url is the same as cacheEntry.key</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4>fontFace<span> :<a>String</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                            ...
                            <hr>
                            <dt>
                                <h4>fontItalic<span> :Boolean</span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>Whether the font is italic.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4>fontSize<span> :<a>Number</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                            ...
                            <hr>
                            <dt>
                                <h4>outlineColor<span> :<a>String</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The color of the outline of the text in CSS format.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4>outlineWidth<span> :<a>Number</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The width of the outline of the text.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4>textColor<span> :<a>String</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The color of the text in CSS format.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
...
<dl>
                            ...
                            <dd>
                                <div>
                                    <p>Bitmap states(Bitmap._loadingState):</p>
                                    <p>none: Empty Bitmap</p>
                                    <p>pending: Url requested, but pending to load until startRequest called</p>
                                    <p>purged: Url request completed and purged.</p>
                                    <p>requesting: Requesting supplied URI now.</p>
                                    <p>requestCompleted: Request completed</p>
                                    <p>decrypting: requesting encrypted data from supplied URI or decrypting it.</p>
                                    <p>decryptCompleted: Decrypt completed</p>
                                    <p>loaded: loaded. isReady() === true, so It&apos;s usable.</p>
