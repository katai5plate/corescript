...
| --- | --- | --- |
| `renderer` | [PIXI.WebGLRenderer](PIXI.WebGLRenderer.html) |

The renderer this plugin works for  |
...
<dl>
                            ...
                            <dd>
                                <div>
                                    <p>Renders the picture object.</p>
                                </div>
                                <h5>Parameters:</h5>
                                <table>
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <span>PIXI.tilemap.PictureSprite</span>
                                            </td>
                                            <td>
                                                <p>the picture to render</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
