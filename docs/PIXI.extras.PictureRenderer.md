...
#### new PictureRenderer (renderer)

Renderer that clamps the texture so neighbour frames wont bleed on it immitates context2d drawImage behaviour

##### Parameters:

| Name | Type | Description |
| --- | --- | --- |
| `renderer` | [PIXI.WebGLRenderer](PIXI.WebGLRenderer.html) | The renderer this plugin works for |
...
<dl>
                    ...
                    <dd>
                        <ul>
                            <li>
                                <a>libs/pixi-picture.js</a>, <a>line 108</a>
                            </li>
                        </ul>
                    </dd>
                </dl>
...
| Name | Type | Description |
| --- | --- | --- |
| `sprite` | PIXI.tilemap.PictureSprite | the picture to render |
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>libs/pixi-picture.js</a>, <a>line 176</a>
                        </li>
                    </ul>
                </dd>
            </dl>
