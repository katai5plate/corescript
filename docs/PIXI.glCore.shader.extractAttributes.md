...
## extractAttributes (gl, program) → {Object}

#### new extractAttributes (gl, program) → {Object}
...
| `program` | WebGLProgram | The shader program to get the attributes from |
...
<dl>
                    ...
                    <dd>
                        <ul>
                            <li>
                                <a>libs/pixi.js</a>, <a>line 1292</a>
                            </li>
                        </ul>
                    </dd>
                </dl>
