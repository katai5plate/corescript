...
<dl>
                    ...
                    <dd>
                        <ul>
                            <li>
                                <a>libs/pixi.js</a>, <a>line 24286</a>
                            </li>
                        </ul>
                    </dd>
                </dl>
...
#### (static) shared :[PIXI.ticker.Ticker](PIXI.ticker.Ticker.html)

The shared ticker instance used by [PIXI.extras.MovieClip](PIXI.extras.MovieClip.html). and by [PIXI.interaction.InteractionManager](PIXI.interaction.InteractionManager.html). The property PIXI.ticker.Ticker#autoStart is set to `true` for this instance. Please follow the examples for usage, including how to opt-out of auto-starting the shared ticker.
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>libs/pixi.js</a>, <a>line 24282</a>
                        </li>
                    </ul>
                </dd>
            </dl>
