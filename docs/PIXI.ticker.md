...
<dl>
                            <hr>
                            <dt>
                                <h4><span>&lt;static&gt; </span>shared<span> :<a>PIXI.ticker.Ticker</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The shared ticker instance used by <a>PIXI.extras.MovieClip</a>. and by <a>PIXI.interaction.InteractionManager</a>. The property PIXI.ticker.Ticker#autoStart is set to <code>true</code> for this instance. Please follow the examples for usage, including how to opt-out of auto-starting the shared ticker.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                                        <span><a>PIXI.ticker.Ticker</a></span>
                                    </li>
                                </ul>
                                <dl>
                                </dl>
                                <h5>Examples</h5>
                                <pre>let ticker = PIXI.ticker.shared;
...
ticker.start();</pre>
                                <pre>// You may use the shared ticker to render...
...
renderer.render(stage);
                                ...
                                <pre>// Or you can just update it manually.
ticker.autoStart = false;
ticker.stop();
