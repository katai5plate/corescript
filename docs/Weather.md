...
<dl>
                            ...
                            <dd>
                                <div>
                                    <p>The origin point of the weather for scrolling.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4>power<span> :<a>Number</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The power of the weather in the range (0, 9).</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4>type<span> :<a>String</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The type of the weather in [&apos;none&apos;, &apos;rain&apos;, &apos;storm&apos;, &apos;snow&apos;].</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
