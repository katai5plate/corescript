...
## [PIXI](PIXI.html).  accessibleTarget

Default property values of accessible objects used by PIXI.accessibility.AccessibilityManager.
<dl>
                    <dt>Source:</dt>
                    <dd>
                        <ul>
                            <li>
                                <a>libs/pixi.js</a>, <a>line 7163</a>
                            </li>
                        </ul>
                    </dd>
                </dl>
