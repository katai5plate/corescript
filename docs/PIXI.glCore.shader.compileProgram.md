...
## compileProgram (gl, vertexSrc, fragmentSrc) → {WebGLProgram}

#### new compileProgram (gl, vertexSrc, fragmentSrc) → {WebGLProgram}

##### Parameters:

| Name | Type | Description |
| --- | --- | --- |
| `gl` | WebGLRenderingContext | The current WebGL context {WebGLProgram} |
...
<dl>
                    ...
                    <dd>
                        <ul>
                            <li>
                                <a>libs/pixi.js</a>, <a>line 1139</a>
                            </li>
                        </ul>
                    </dd>
                </dl>
