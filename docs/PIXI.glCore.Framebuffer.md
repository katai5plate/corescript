...
<dl>
                            <hr>
                            <dt>
                                <h4>framebuffer<span> :WebGLFramebuffer</span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The frame buffer</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                                        <span>WebGLFramebuffer</span>
                                    </li>
                                </ul>
                                <dl>
                                </dl>
                            ...
                            <dd>
                                <div>
                                    <p>The height of the drawing area of the buffer</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4>stencil<span> :WebGLRenderbuffer</span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The stencil buffer</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                                        <span>WebGLRenderbuffer</span>
                                    </li>
                                </ul>
                                <dl>
                                </dl>
                            ...
                            <hr>
                            <dt>
                                <h4>texture<span> :PIXI.glCore.GLTexture</span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The stencil buffer</p>
                                ...
                                <ul>
                                    <li>
                                        <span>PIXI.glCore.GLTexture</span>
                                    </li>
                                </ul>
                                <dl>
                                </dl>
                            ...
                            <dd>
                                <div>
                                    <p>The width of the drawing area of the buffer</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
...
<dl>
                            <hr>
                            <dt>
                                <h4><span>&lt;static&gt; </span>createFloat32(gl, width, height, data)</h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>Creates a frame buffer with a texture containing the given data</p>
                                </div>
                                <h5>Parameters:</h5>
                                <table>
                                    <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p>the width of the drawing area of the frame buffer</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <p>the height of the drawing area of the frame buffer</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><code>data</code></td>
                                            <td>
                                                <span>ArrayBuffer</span> | <span>SharedArrayBuffer</span> | <span>ArrayBufferView</span>
                                            </td>
                                            <td>
                            ...
                            <hr>
                            <dt>
                                <h4><span>&lt;static&gt; </span>createRGBA(gl, width, height, data)</h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>Creates a frame buffer with a texture containing the given data</p>
                            ...
                            <dd>
                                <div>
                                    <p>Binds the frame buffer to the WebGL context</p>
                                </div>
                                <dl>
                                </dl>
                            </dd>
                            ...
                            <dd>
                                <div>
                                    <p>Erases the drawing area and fills it with a colour</p>
                                </div>
                                <h5>Parameters:</h5>
                                <table>
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <p>the red value of the clearing colour</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><code>g</code></td>
                                            ...
                                            <td>
                                                <p>the green value of the clearing colour</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><code>b</code></td>
                                            ...
                                            <td>
                                                <p>the blue value of the clearing colour</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><code>a</code></td>
                                            ...
                                            <td>
                                                <p>the alpha value of the clearing colour</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <dd>
                                <div>
                                    <p>Initialises the stencil buffer</p>
                                </div>
                                <dl>
                                </dl>
                            </dd>
                            <hr>
                            <dt>
                                <h4>enableTexture(texture)</h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>Adds a texture to the frame buffer</p>
                                </div>
                                <h5>Parameters:</h5>
                                <table>
                                    <thead>
                            ...
                            <dd>
                                <div>
                                    <p>Resizes the drawing area of the buffer to the given width and height</p>
                                </div>
                                <h5>Parameters:</h5>
                                <table>
                                    <thead>
                            ...
                            <dd>
                                <div>
                                    <p>Unbinds the frame buffer to the WebGL context</p>
                                </div>
                                <dl>
                                </dl>
                            </dd>
