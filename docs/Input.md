...
<dl>
                            <hr>
                            <dt>
                                <h4><span>&lt;static&gt; </span>gamepadMapper<span> :Object</span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>A hash table to convert from a gamepad button to a mapped key name.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4><span>&lt;static&gt; </span>keyMapper<span> :Object</span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>A hash table to convert from a virtual key code to a mapped key name.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4><span>&lt;static&gt; </span>keyRepeatInterval<span> :<a>Number</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The interval of the key repeat in frames.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                                ...
                                <dl>
                                    ...
                                    <dl>
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><code>keyRepeatInterval</code></td>
                                                    <td>
                                                    </td>
                                                    <td></td>
                                                </tr>
                            ...
                            <hr>
                            <dt>
                                <h4><span>&lt;static&gt; </span>keyRepeatWait<span> :<a>Number</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The wait time of the key repeat in frames.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
