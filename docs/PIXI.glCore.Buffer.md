...
| `type` | gl.ARRAY_BUFFER |gl.ELEMENT_ARRAY_BUFFER | @mat |
...
| Name | Type | Description |
| --- | --- | --- |
| `data` | ArrayBuffer |SharedArrayBuffer |ArrayBufferView | an array of data to upload |
| `offset` | [Number](Number.html) | if only a subset of the data should be uploaded, this is the amount of data to subtract |
| `dontBind` | Boolean | whether to bind the buffer before uploading it |
