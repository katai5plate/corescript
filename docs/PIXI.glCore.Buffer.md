...
#### new Buffer(gl, type, data, drawType)
...
<dl>
                            <hr>
                            <dt>
                                <h4>buffer<span> :WebGLBuffer</span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The WebGL buffer, created upon instantiation</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                                        <span>WebGLBuffer</span>
                                    </li>
                                </ul>
                                <dl>
                                </dl>
                            ...
                            <hr>
                            <dt>
                                <h4>data<span> :ArrayBuffer|SharedArrayBuffer|ArrayBufferView</span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The data in the buffer, as a typed array</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4>drawType<span> :gl.STATIC_DRAW|gl.DYNAMIC_DRAW|gl.STREAM_DRAW</span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The draw type of the buffer</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                                        <span>gl.STATIC_DRAW</span> | <span>gl.DYNAMIC_DRAW</span> | <span>gl.STREAM_DRAW</span>
                                    </li>
                                </ul>
                                <dl>
                                </dl>
                            ...
                            <hr>
                            <dt>
                                <h4>type<span> :gl.ARRAY_BUFFER|gl.ELEMENT_ARRAY_BUFFER</span></h4>
                            </dt>
                            <dd>
                                <div>
                                ...
                                <ul>
                                    <li>
                                        <span>gl.ARRAY_BUFFER</span> | <span>gl.ELEMENT_ARRAY_BUFFER</span>
                                    </li>
                                </ul>
                                <dl>
                                </dl>
...
<dl>
                            ...
                            <hr>
                            <dt>
                                <h4>upload(data, offset, dontBind)</h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>Uploads the buffer to the GPU</p>
                                </div>
                                <h5>Parameters:</h5>
                                <table>
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <p>an array of data to upload</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <p>if only a subset of the data should be uploaded, this is the amount of data to subtract</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><code>dontBind</code></td>
                                            <td>
                                                <span>Boolean</span>
                                            </td>
                                            <td>
                                                <p>whether to bind the buffer before uploading it</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
