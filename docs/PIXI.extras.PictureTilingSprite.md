# Class: PictureTilingSprite

## PictureTilingSprite (texture, width, height)

#### new PictureTilingSprite (texture, width, height)
...
| --- | --- | --- |
| `texture` | [PIXI.Texture](PIXI.Texture.html) | the texture for this sprite |
| `width` | number | width |
...
<dl>
                    ...
                    <dd>
                        <ul>
                            <li>
                                <a>libs/pixi-picture.js</a>, <a>line 583</a>
                            </li>
                        </ul>
                    </dd>
                </dl>
