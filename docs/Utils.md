...
<dl>
                            <hr>
                            <dt>
                                <h4><span>&lt;static, readonly&gt; </span>RPGMAKER_NAME<span> :<a>String</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The name of the RPG Maker. &apos;MV&apos; in the current version.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4><span>&lt;static, readonly&gt; </span>RPGMAKER_VERSION<span> :<a>String</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The version of the RPG Maker.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                                ...
                                <dl>
                                    ...
                                    <dl>
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><code>RPGMAKER_VERSION</code></td>
                                                    <td>
                                                    </td>
                                                    <td></td>
                                                </tr>
