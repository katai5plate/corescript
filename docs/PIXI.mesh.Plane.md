...
The Plane allows you to draw a texture across several points and them manipulate these points ```js for (let i = 0; i < 20; i++) { points.push(new PIXI.Point(i * 50, 0)); }; let Plane=new PIXI.Plane(PIXI.Texture.fromImage("snake.png"), points); ```
<dl>
                        <dt>Source:</dt>
                        <dd>
                            <ul>
                                <li>
                                    <a>libs/pixi.js</a>, <a>line 32503</a>
                                </li>
                            </ul>
                        </dd>
                        </dl>
