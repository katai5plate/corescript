...
## [PIXI](PIXI.html).  Shader ()

#### new Shader ()

Wrapper class, webGL Shader for Pixi. Adds precision string if vertexSrc or fragmentSrc have no mention of it.
<dl>
                    <dt>Source:</dt>
                    <dd>
                        <ul>
                            <li>
                                <a>libs/pixi.js</a>, <a>line 7283</a>
                            </li>
                        </ul>
                    </dd>
                </dl>
