# Class: mapWebGLDrawModesToPixi

## [PIXI](PIXI.html).  mapWebGLDrawModesToPixi (gl, object opt) → {object}

#### new mapWebGLDrawModesToPixi (gl, object opt) → {object}
...
| `object` | object | <optional> | {} | The object to map into |
...
<dl>
                    ...
                    <dd>
                        <ul>
                            <li>
                                <a>libs/pixi.js</a>, <a>line 18952</a>
                            </li>
                        </ul>
                    </dd>
                </dl>
