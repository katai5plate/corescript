...
## Shader (gl, vertexSrc, fragmentSrc)
...
| `vertexSrc` | string | [Array](Array.html).<string> | The vertex shader source as an array of strings. |
| `fragmentSrc` | string | [Array](Array.html).<string> | The fragment shader source as an array of strings. |
