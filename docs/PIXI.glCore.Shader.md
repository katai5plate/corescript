...
#### new Shader(gl, vertexSrc, fragmentSrc)
...
| `vertexSrc` | string | [Array](Array.html).<string> |

The vertex shader source as an array of strings.  |
| `fragmentSrc` | string | [Array](Array.html).<string> |
...
<dl>
                            <hr>
                            <dt>
                                <h4>attributes<span> :Object</span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The attributes of the shader as an object containing the following properties { type, size, location, pointer }</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4>program<span> :WebGLProgram</span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The shader program</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                                        <span>WebGLProgram</span>
                                    </li>
                                </ul>
                                <dl>
                                </dl>
                            ...
                            <hr>
                            <dt>
                                <h4>uniforms<span> :Object</span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The uniforms of the shader as an object containing the following properties { gl, data }</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
