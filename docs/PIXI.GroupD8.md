...
## [PIXI](PIXI.html). GroupD8

Implements Dihedral Group D_8, see [group D4](http://mathworld.wolfram.com/DihedralGroupD4.html), D8 is the same but with diagonals. Used for texture rotations.
