...
<dl>
                            ...
                            <hr>
                            <dt>
                                <h4>setTimeToLive(ticks, time)</h4>
                            </dt>
                            <dd>
                                <div>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p>TTL in seconds, 0 if not set</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <dd>
                                <div>
                                    <p>makes sure that resource wont freed by Time To Live if resource was already freed by TTL, put it in cache again</p>
                                </div>
                                <dl>
                                </dl>
                            </dd>
