...
## CacheEntry (resource, key,, item)

CacheEntry

## Constructor

#### new CacheEntry (resource, key,, item)
...
<dl>
                    ...
                    <dd>
                        <ul>
                            <li>
                                <a>rpg_core/CacheEntry.js</a>, <a>line 11</a>
                            </li>
                        </ul>
                    </dd>
                </dl>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>rpg_core/CacheEntry.js</a>, <a>line 38</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>rpg_core/CacheEntry.js</a>, <a>line 26</a>
                        </li>
                    </ul>
                </dd>
            </dl>

#### setTimeToLive (ticks, time) → {[CacheEntry](CacheEntry.html)}
...
| Name | Type | Description |
| --- | --- | --- |
| `ticks` | number | TTL in ticks, 0 if not set |
| `time` | number | TTL in seconds, 0 if not set |
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>rpg_core/CacheEntry.js</a>, <a>line 53</a>
                        </li>
                    </ul>
                </dd>
            </dl>
...
<dl>
                ...
                <dd>
                    <ul>
                        <li>
                            <a>rpg_core/CacheEntry.js</a>, <a>line 69</a>
                        </li>
                    </ul>
                </dd>
            </dl>
