...
## extractUniforms (gl, program) → {Object}

#### new extractUniforms (gl, program) → {Object}
...
| `program` | WebGLProgram | The shader program to get the uniforms from |
...
<dl>
                    ...
                    <dd>
                        <ul>
                            <li>
                                <a>libs/pixi.js</a>, <a>line 1334</a>
                            </li>
                        </ul>
                    </dd>
                </dl>
