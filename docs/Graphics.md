...
<dl>
                            <hr>
                            <dt>
                                <h4><span>&lt;static, readonly&gt; </span>BLEND_ADD<span> :<a>Number</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The alias of PIXI.blendModes.ADD.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4><span>&lt;static, readonly&gt; </span>BLEND_MULTIPLY<span> :<a>Number</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The alias of PIXI.blendModes.MULTIPLY.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                                ...
                                <dl>
                                    ...
                                    <dl>
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><code>BLEND_MULTIPLY</code></td>
                                                    <td>
                                                    </td>
                                                    <td></td>
                                                </tr>
                            ...
                            <hr>
                            <dt>
                                <h4><span>&lt;static, readonly&gt; </span>BLEND_NORMAL<span> :<a>Number</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The alias of PIXI.blendModes.NORMAL.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4><span>&lt;static, readonly&gt; </span>BLEND_SCREEN<span> :<a>Number</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The alias of PIXI.blendModes.SCREEN.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4><span>&lt;static&gt; </span>frameCount<span> :<a>Number</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The total frame count of the game screen.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
...
<dl>
                            <hr>
                            <dt>
                                <h4><span>&lt;static&gt; </span>callGC()</h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>Calls pixi.js garbage collector</p>
                                </div>
                                <dl>
                                </dl>
                            </dd>
