...
## [PIXI](PIXI.html).  VideoBaseTexture ()

#### new VideoBaseTexture ()

A texture of a [playing] Video. Video base textures mimic Pixi BaseTexture.from.... method in their creation process. This can be used in several ways, such as: ```js let texture = PIXI.VideoBaseTexture.fromUrl('http://mydomain.com/video.mp4'); let texture = PIXI.VideoBaseTexture.fromUrl({ src: 'http://mydomain.com/video.mp4', mime: 'video/mp4' }); let texture = PIXI.VideoBaseTexture.fromUrls(['/video.webm', '/video.mp4']); let texture = PIXI.VideoBaseTexture.fromUrls([ { src: '/video.webm', mime: 'video/webm' }, { src: '/video.mp4', mime: 'video/mp4' } ]); ``` See the ["deus" demo](http://www.goodboydigital.com/pixijs/examples/deus/).
<dl>
                    <dt>Source:</dt>
                    <dd>
                        <ul>
                            <li>
                                <a>libs/pixi.js</a>, <a>line 23547</a>
                            </li>
                        </ul>
                    </dd>
                </dl>
