...
<dl>
                            <hr>
                            <dt>
                                <h4>animationCount<span> :<a>Number</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The animation count for autotiles.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                                ...
                                <dl>
                                    ...
                                    <dl>
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><code>animationCount</code></td>
                                                    <td>
                                                    </td>
                                                    <td></td>
                                                </tr>
                            ...
                            <hr>
                            <dt>
                                <h4>bitmaps<span> :<a>Array</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The bitmaps used as a tileset.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4>flags<span> :<a>Array</a></span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>The tileset flags.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4>horizontalWrap<span> :Boolean</span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>Whether the tilemap loops horizontal.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                                ...
                                <dl>
                                    ...
                                    <dl>
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><code>horizontalWrap</code></td>
                                                    <td>
                                                    </td>
                                                    <td></td>
                                                </tr>
                            ...
                            <dd>
                                <div>
                                    <p>The origin point of the tilemap for scrolling.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
                            ...
                            <hr>
                            <dt>
                                <h4>verticalWrap<span> :Boolean</span></h4>
                            </dt>
                            <dd>
                                <div>
                                    <p>Whether the tilemap loops vertical.</p>
                                </div>
                                <h5>Type:</h5>
                                <ul>
                                    <li>
