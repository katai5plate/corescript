# Mixin: interactiveTarget

## interactiveTarget

Default property values of interactive objects Used by [PIXI.interaction.InteractionManager](PIXI.interaction.InteractionManager.html) to automatically give all DisplayObjects these properties
<dl>
                    <dt>Source:</dt>
                    <dd>
                        <ul>
                            <li>
                                <a>libs/pixi.js</a>, <a>line 31204</a>
                            </li>
                        </ul>
                    </dd>
                </dl>
